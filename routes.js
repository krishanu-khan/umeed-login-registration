...
router.get('/borrower', ifNotLoggedin, borrowerPage);
router.get('/retaillender', ifNotLoggedin, retailLenderPage);
router.get('/microcorp', ifNotLoggedin, microcorpPage);

router.get("/login", ifLoggedin, loginPage);
router.post("/login",
ifLoggedin,
    [
        body("_name", "Invalid Username")
            .notEmpty()
            .escape()
            .trim(),
...
router.post(
    ...
    [
        ...
        body("_password", "The Password must be of minimum 4 characters length")
            ...
            .trim()
            .isLength({ min: 4 }),
		body("_optradio", "Please select appropriate role")
            .notEmpty()
            .trim(),
    ],
    register
